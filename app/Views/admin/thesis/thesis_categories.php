    ...
    <div class="main-wrapper">
        ...
        <div class="page-wrapper">
            ...
            <div class="page-content">
                <div class="card">
                    <div class="card-body">
                        <h6 class="card-title">Add Thesis Popular Category Details</h6>
                        <form class="forms-sample" action="<?= base_url('admin/thesis-categories') ?>" method="POST" enctype="multipart/form-data">
                            <?= csrf_field(); ?>
