...
<head>
    ...
    <title>Candil Portal | Administrator Login </title>
                        ...
                        <div class="row">
                            <div class="col-md-12 ps-md-0">
                                <div class="auth-form-wrapper px-4 py-5">
                                    <a href="#" class="noble-ui-logo d-block mb-2">Candil<span>Portal</span></a>
                                    ...
                                    <form action="" method="POST" class="forms-sample">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="email" name="email" class="form-control" value="<?= set_value('email') ?>" id="userEmail" placeholder="Email">
                                        </div>
                                        <div class="mb-3">
